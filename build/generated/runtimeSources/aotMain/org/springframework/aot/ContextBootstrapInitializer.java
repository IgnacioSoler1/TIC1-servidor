...
public class ContextBootstrapInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("com.example.servidor.ServidorApplication", ServidorApplication.class)
        .instanceSupplier(ServidorApplication::new).register(beanFactory);
    com.example.servidor.Controllers.ContextBootstrapInitializer.registerUsuarioController(beanFactory);
    ...
    com.example.servidor.services.ContextBootstrapInitializer.registerUsuarioService(beanFactory);
