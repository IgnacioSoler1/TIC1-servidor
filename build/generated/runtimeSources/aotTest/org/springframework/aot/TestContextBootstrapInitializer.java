...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.servidor.ServidorApplicationTests", () -> new AotSpringBootConfigContextLoader(ServidorApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.servidor.ServidorApplicationTests", ServidorApplicationTestsContextInitializer.class);
    return entries;
  }
}
